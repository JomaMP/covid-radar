...
class _PageStatistics extends State<PageStatistics> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title: Text('COVID-19 Estadísticas'),
                        ...
                        child: Container(
                            ...
                            child: Center(
                                child: Column(
                                  ...
                                  Image(
                                    image: AssetImage(
                                        "statistics_images/hospital.png"),
                                    height: 100,
                                    width: 100,
                                  ),
                                  Padding(padding: EdgeInsets.all(10)),
                        ...
                        child: Container(
                            ...
                            child: Center(
                                child: Column(
                                  ...
                                  Image(
                                    image:
                                        AssetImage("statistics_images/hs.png"),
                                    height: 120,
                                    width: 120,
                                  ),
                                  Padding(padding: EdgeInsets.all(10)),
                  ...
                  child: Container(
                      ...
                      child: Center(
                          child: Column(
                            ...
                            Padding(padding: EdgeInsets.only(top: 20.0)),
                            Image(
                              image: AssetImage("statistics_images/myth.png"),
                              height: 100,
                              width: 100,
                            ),
                            Padding(padding: EdgeInsets.all(10)),
